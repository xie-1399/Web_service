...
from platform_management.models import Total
...
class WelcomeView(View):
    def get(self, request):
        ...
        return render(request,'users/Begin.html',context=context)
...
class IndexView(LoginStatusCheck, View):
    def get(self, request):
        ...
        # else:
        #     weather = 'unknow'
        Get_people_Nums=Total.objects.all().count()
        new_people_lists=Total.objects.filter(year='2022')
        weather_name = '晴'
        weather = 'sun'
        temperature = '28'
        ...
        context = {
            ...
            'ym_lists': ym_lists,
            'Get_people_Nums':Get_people_Nums,
            'tr_lists': tr_lists,
            'dep_list': dep_list,
            'new_people_lists':new_people_lists,
            'msgs': msgs,
        }
